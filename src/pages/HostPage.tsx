        ...
        {mainTab === "single" ? (
          ...
          <div className="space-y-3 py-1">
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-1.5">{t("batch.hint")}</p>
              <textarea
      ...
      {hosts.length > 0 && !loading && (
        <div className="flex items-center gap-2 mb-3 px-1">
          ...
          >
            ...
            {selected.size === hosts.length ? t("page.deselectAll") : t("page.selectAll")}
          </button>
        </div>
      )}
                ...
                <CardContent className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {host.enabled ? t("status.enabled") : t("status.disabled")}
                      </Badge>
                    </div>
                  ...
                  <div className="flex items-center gap-0.5 shrink-0">
                    ...
                    <Button
                      variant="ghost"
                      size="icon-xs"
                      title={host.enabled ? t("actions.disable") : t("actions.enable")}
                      disabled={isToggling}
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        ...
                        setConfirm({
                          ...
                          description: t("page.removeDesc", { domain: host.domain }),
                          onConfirm: () => {
                            setConfirm(null);
